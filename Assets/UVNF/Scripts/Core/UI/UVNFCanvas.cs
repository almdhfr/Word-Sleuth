...
namespace UVNF.Core.UI
{
    public class UVNFCanvas : MonoBehaviour
    {
        ...
        public CanvasGroup CharactersCanvasGroup;
        ...
        public IEnumerator DisplayText(string text, params TextDisplayStyle[] displayStyles)
        {
            ...
            // Debug.Log("Displaying style: " + displayStyles);
        ...
        #region Utility
        public Coroutine StartFade(CanvasGroup canvasGroup, bool fade = false, float fadetime = 1f)
        {
            if(fade)
                return StartCoroutine(FadeCanvasGroup(canvasGroup,fadetime));
            else
                return StartCoroutine(UnfadeCanvasGroup(canvasGroup,fadetime));
        }
        ...
        public void ShowLoadScreen(float time = 1f, bool hideOtherComponents = false)
        {
            ...
            Debug.Log("bool " + hideOtherComponents);
            if (hideOtherComponents)
            {
                Debug.Log("Hiding other components");
